...
<template>
    ...
    <div v-if="Object.keys(listings.data).length">
      <div class="mb-6">
        ...
        <div class="flex items-center justify-between mb-4">
          ...
          <div class="flex items-center gap-4 text-l">
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="w-1/5 py-3 pr-3 text-right text-green-500">
  ...
  <div v-else>
    Due to violation of our terms of service, your account has been suspended, Please
